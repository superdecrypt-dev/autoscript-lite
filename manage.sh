...
XRAY_DOMAIN_GUARD_CONFIG_FILE="${XRAY_DOMAIN_GUARD_CONFIG_FILE:-${DOMAIN_GUARD_CONFIG_FILE:-/etc/xray-domain-guard/config.env}}"
XRAY_DOMAIN_GUARD_LOG_FILE="${XRAY_DOMAIN_GUARD_LOG_FILE:-${DOMAIN_GUARD_LOG_DIR:-/var/log/xray-domain-guard}/domain-guard.log}"
...
: "${WIREPROXY_CONF}" "${WGCF_DIR}" "${CUSTOM_GEOSITE_DAT}" "${ADBLOCK_GEOSITE_ENTRY}" \
  "${WIREGUARD_DIR}" "${XRAY_WARP_SYNC_BIN}" \
