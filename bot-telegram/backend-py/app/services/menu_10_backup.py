        ...
        return ok_response(
            ...
            "\n".join(
                [
                    ...
                    "  3. Jalankan port forwarding ke VPS dengan tool pilihan Anda",
                    f"     lalu arahkan 127.0.0.1:53682 ke {tunnel_host}:53682",
        ...
        return ok_response(
            ...
            "\n".join(
                [
                    ...
                    f"12. Jalankan manual bila ingin cek: rclone lsf {remote}:{bucket}",
