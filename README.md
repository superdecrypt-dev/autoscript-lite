...
- Jumlah akun: `VLESS | VMESS | TROJAN | SS | SS2022`
...
- Scope enforcement SSH saat ini: `quota_used`, quota traffic, IP/login limit, dan speed limit berlaku pada jalur SSHWS; login SSH native via `sshd`/port `22` belum dihitung atau di-throttle oleh SSH QAC.
