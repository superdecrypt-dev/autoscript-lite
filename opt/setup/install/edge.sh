...
EDGE_XRAY_TLS_BACKEND="${EDGE_XRAY_TLS_BACKEND:-${EDGE_NGINX_TLS_BACKEND:-127.0.0.1:18443}}"
EDGE_XRAY_WS_BACKEND="${EDGE_XRAY_WS_BACKEND:-${EDGE_NGINX_HTTP_BACKEND:-127.0.0.1:18080}}"
EDGE_XRAY_FALLBACK_BACKEND="${EDGE_XRAY_FALLBACK_BACKEND:-${EDGE_NGINX_TLS_BACKEND:-127.0.0.1:18443}}"
EDGE_XRAY_QUOTA_ROOT="${EDGE_XRAY_QUOTA_ROOT:-/opt/quota/xray}"
EDGE_XRAY_RUNTIME_UNIT="${EDGE_XRAY_RUNTIME_UNIT:-xray}"
