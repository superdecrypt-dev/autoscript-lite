...
HYSTERIA2_EXPIRED_INTERVAL="${HYSTERIA2_EXPIRED_INTERVAL:-60}"
HYSTERIA2_ACCOUNT_ROOT="${HYSTERIA2_ACCOUNT_ROOT:-/opt/account/hysteria2}"
HYSTERIA2_BRUTAL_UP="${HYSTERIA2_BRUTAL_UP:-20 mbps}"
HYSTERIA2_BRUTAL_DOWN="${HYSTERIA2_BRUTAL_DOWN:-50 mbps}"
HYSTERIA2_UDPHOP_PORTS="${HYSTERIA2_UDPHOP_PORTS:-20000-40000}"
HYSTERIA2_UDPHOP_INTERVAL="${HYSTERIA2_UDPHOP_INTERVAL:-5}"
HYSTERIA2_UDPHOP_RULES_BIN="${HYSTERIA2_UDPHOP_RULES_BIN:-/usr/local/bin/hysteria2-udphop-rules}"
HYSTERIA2_UDPHOP_SERVICE="${HYSTERIA2_UDPHOP_SERVICE:-hysteria2-udphop.service}"
HYSTERIA2_PORT="${HYSTERIA2_PORT:-443}"
HYSTERIA2_MASQUERADE_URL="${HYSTERIA2_MASQUERADE_URL:-https://www.microsoft.com/}"
