...
XRAY_WARP_INTERFACE="${XRAY_WARP_INTERFACE:-warp-xray0}"
XRAY_WARP_BACKEND="${XRAY_WARP_BACKEND:-auto}"
XRAY_WARP_REDIR_PORT="${XRAY_WARP_REDIR_PORT:-12345}"
XRAY_WARP_REDIR_PORT_V6="${XRAY_WARP_REDIR_PORT_V6:-12346}"
...
HYSTERIA2_ACCOUNT_ROOT="${HYSTERIA2_ACCOUNT_ROOT:-/opt/account/hysteria2}"
HYSTERIA2_PORT="${HYSTERIA2_PORT:-8448}"
HYSTERIA2_MASQUERADE_URL="${HYSTERIA2_MASQUERADE_URL:-https://www.cloudflare.com/}"
